...
Ver instrucciones del Backend

🔵 Frontend (/frontend)

(En desarrollo) Aplicación web construida con React, Next.js y Tailwind CSS.

Ver instrucciones del Frontend (Próximamente)
...
Frontend: React, Next.js (Planeado).
...
Desarrollado por Willan Alexander Díaz Cordova. 🦖